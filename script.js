...
const translations = {
  en: {
    ...
    "interested": "Interested in automating your business?",
    about: "About Me",
    "about-title": "About Me",
    "about-text": "I'm a business automation specialist helping companies streamline operations, boost efficiency, and scale faster. I specialize in setting up intelligent workflows using tools like n8n, Make, and Directus, integrating AI where it brings the most value.\n\nMy expertise includes email marketing automation (Amazon SES, HTML design, domain warm-up), CRM setup, sales analytics, and creating high-converting landing pages. I also build AI-powered bots that engage leads, answer customer questions, and automate decision-making.\n\nWhether you're a startup or an established business, I’ll help you build smart systems that work for you — not the other way around.",
    "ai-chatbot": "AI Chatbot",
    ...
    ua: {
      ...
      es: {
        ...
        "phone-placeholder": "Ingresa tu número de teléfono",
        message: "Mensaje",
        send: "Enviar",
        about: "Sobre mí",
      }
